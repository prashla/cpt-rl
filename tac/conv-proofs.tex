...
%= & \left|\int_0^{n^c} w^+\left(\Prob{u^+(X)>t}\right) dt- \int_0^{n^c} w^+\left(1- {\hat F^+_n}(t)\right) dt\right|\\
%+ & \left|\int_{n^c}^{\infty} w^+\left(\Prob{u^+(X)>t}\right) dt\right|,
...
%\leq \int_{n^c}^\infty \frac{s}{n^c} w \left(\mathbb{P} \left( X > s \right)\right) ds\\
...
%An easy observation indicates that if $\left| \int_{n^c}^\infty w^+\left(\mathbb{P} \left( u^+(X) > t \right)\right) dt\right| \leq \frac{\epsilon}{2}$, then a necessary condition for 
%$$\left|\int_0^{\infty} w^+\left(\Prob{u^+(X)>t}\right) dt- \int_0^{n^c} w^+\left(1- {\hat F^+_n}(t)\right) dt\right| > \epsilon$$ is 

%$$\left|\int_0^{n^c}\!\! w^+ \left(\Prob{u^+(X)>t}\right)dt \!\!-\!\! 
%\int_0^{n^c}\!\!w^+\left(1- {\hat F^+_n}(t)\right) dt\right| > \frac{\epsilon}{2}.$$
