%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Proofs for CPT-value predictor}
...
& \Prob { u^+(X_{[i]}) - \xi^+_{\frac{i}{n}} > \frac {\epsilon}{\nalpha}}  
 = \Prob { \sum _{j=1}^{n} W_j > n\cdot\left(1-\frac{i}{n}\right)} \\ 
& = \mathbb{P} \left( \sum _{j=1}^{n} W_j - n \cdot \left[1-F^{+}\left(\xi^+_{\frac{i}{n}}
...
\begin{align*}
&\mathbb{P} \left( \sum _{i=1}^{n} W_j - n \cdot \left[1-F^{+}\left(\xi^+_{\frac{i}{n}} +\frac{\epsilon}{n^{(1-\alpha) }  } \right) \right] \right.\\
&\left.\qquad> n
...
&  \E \left|\overline \C_n- \C(X) \right|  
  ...
  &\le \intinfinity \exp(-n\epsilon^{2/\alpha}/4H^2M^2) d\epsilon \le \frac{(2H M)^\alpha \Gamma\left(\alpha/2\right)}{n^{\alpha/2}}.
 \end{align*}
\end{proof}
