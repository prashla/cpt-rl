...
$2n e^{-2n^{\alpha} L^{+}}$ will decrease faster than the sequence
...
Notice  that
\begin{align*}
&\int_{n^c}^\infty w\left(\mathbb{P} \left( X > s \right)\right) ds
\leq \frac{1}{n^c} \int_{n^c}^\infty \frac{s}{n^c} e^{-2\alpha s^2} ds\\
=&n^c \frac{4}{\alpha} e^{-2\alpha \left(n^c\right)^2} \leq \frac{\epsilon}{2} \text{ for } n \geq \left(\frac{\ln2 - \ln\epsilon}{2\alpha}\right)^{\frac{1}{c}}.
\end{align*}
%Hence, for $$, we have 
