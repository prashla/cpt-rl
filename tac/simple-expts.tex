...
We illustrate that the estimator in Algorithm \ref{alg:holder-est} converges rapidly by considering a skew normal distributed  r.v. with location, scale and shape parameters set to $2,1$ and $2$, respectively. 
