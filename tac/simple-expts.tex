 \begin{figure*}
  ...
  \caption{CPT-value of normal distributed r.v.s with parameters mean $\mu$ and variance $\sigma$. The red and green dots indicate expected and CPT-value optima, respectively. The value on the z-axis of the red dot represents the analytical mean of its corresponding $\mu$ and $\sigma$.}
