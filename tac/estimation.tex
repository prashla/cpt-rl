...
Assume (A1), (A2) and also that the utilities $u^+(X)$ and $u^-(X)$  subgaussian random variables. Then, $\forall \epsilon >0$,if $n$ is large enough, we have
%$
...
$$
\Prob{\left| \overline \C_n - \C(X) \right|\geq  \epsilon}\leq 2n e^{-\frac{1}{2+\alpha}} 
+ 2 e^{-{\frac{1}{2+\alpha}}\left(\frac{\epsilon}{2H}\right)^{\frac{2}{\alpha}}}
$$
\end{proposition}
