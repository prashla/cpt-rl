...
\subsection{Gradient algorithm for CPT-value optimization (CPT-SPSA-G)}
\label{sec:1spsa}
...
\paragraph{Update rule} We incrementally update the parameter $\theta$ in the ascent direction as follows: For $i=1,\ldots,d$,
\begin{align}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Newton algorithm for CPT-value optimization (CPT-SPSA-N)}
\label{sec:2spsa}
\paragraph{Need for second-order methods}
