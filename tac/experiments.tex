...
\pgfplotsset{every x tick label/.append style={font=\scriptsize}}
 ...
 \begin{figure*}
    \centering
     \begin{tabular}{cc}
\subfigure[Expected delay (path-wise). The black squares indicate baseline delays.]{
\label{fig:avg}
\hspace{-2em} 
...
\node [rectangle,fill=black,inner sep=0pt,minimum size=4pt]  at (axis cs:1,137) {}; % 0-1
\node [rectangle,fill=black,inner sep=0pt,minimum size=4pt]  at (axis cs:2,132) {}; % 0-2
\node [rectangle,fill=black,inner sep=0pt,minimum size=4pt]  at (axis cs:3,135) {}; % 0-3
\node [rectangle,fill=black,inner sep=0pt,minimum size=4pt]  at (axis cs:4,111) {}; % 1-0
\node [rectangle,fill=black,inner sep=0pt,minimum size=4pt]  at (axis cs:5,110) {}; % 1-2
\node [rectangle,fill=black,inner sep=0pt,minimum size=4pt]  at (axis cs:6,117) {}; % 1-3
\node [rectangle,fill=black,inner sep=0pt,minimum size=4pt]  at (axis cs:7,125) {}; % 2-0
\node [rectangle,fill=black,inner sep=0pt,minimum size=4pt]  at (axis cs:8,141) {}; % 2-1
\node [rectangle,fill=black,inner sep=0pt,minimum size=4pt]  at (axis cs:9,147) {}; % 2-3
\node [rectangle,fill=black,inner sep=0pt,minimum size=4pt]  at (axis cs:10,115) {}; % 3-0
\node [rectangle,fill=black,inner sep=0pt,minimum size=4pt]  at (axis cs:11,114) {}; % 3-1
\node [rectangle,fill=black,inner sep=0pt,minimum size=4pt]  at (axis cs:12,116) {}; % 3-2
...
\noindent{\bf\em CPT-SPSA}: This is a first-order algorithm (see Algorithm \ref{alg:1spsa}) that solves \eqref{eq:cpt-traffic} using SPSA-based gradient estimates and Algorithm \ref{alg:holder-est} for estimating CPT-value $\C(B_i-X_i)$ for each path $i=1,\ldots,\M$, with $d_n^{i,j}, j=1,\ldots,n_i$ as the samples.
