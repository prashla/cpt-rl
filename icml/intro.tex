...
As compared to prospect theory, CPT is monotone with respect to stochastic dominance, a property
	that is thought to be useful and (mostly) consistent with human preferences\footnote{See Appendix \ref{sec:appendix-cpt-intro} for an introduction to PT/CPT and a description of Allais paradox.}.	
