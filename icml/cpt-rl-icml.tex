...
We propose a gradient-based policy optimization algorithm based on the well-known simulation optimization idea of simultaneous perturbation stochastic approximation (SPSA).
