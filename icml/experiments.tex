...
The actions are the feasible sign configurations. 
%Traffic lights that can be simultaneously switched to green form a sign configuration. 
\todoc{What is this last sentence doing here? What do we want to say with it?}
...
Using a Boltzmann policy that has the form\footnote{the features $\phi(s,a)$ are chosen as in \cite{prashanth2012threshold}}\\
$
