...
Using a Boltzmann policy that has the form\footnote{The features $\phi(s,a)$, used in the policy $\pi_{\theta}(s,a)$, are chosen as described in Section V-B of \cite{prashanth2012threshold}.}\\[0.5ex]
\centerline{$
